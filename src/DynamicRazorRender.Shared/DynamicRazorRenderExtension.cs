...
{
    public static class DynamicRenderRazorExtension
    {
        public static IServiceProvider? ServiceProvider { get; private set; }
        public static CodeEnvironment CodeEnvironment { get; private set; }

        public static List<PortableExecutableReference> PortableExecutableReferences = new();

        public static async void AddDynamicRazorRenderShared(this IServiceCollection services, CodeEnvironment codeEnvironment = CodeEnvironment.WebAssembly)
        {
        ...
        static List<RazorExtension> GetRazorExtension()
        {
            ...
            foreach (var asm in typeof(DynamicRenderRazorExtension).Assembly.GetReferencedAssemblies())
            {
